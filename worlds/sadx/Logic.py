...
from .Enums import LogicLevelDifficulty, Character, Area, SubLevel, LevelMission, pascal_to_space, SubLevelMission, Capsule, Enemy, \
    Fish
...
class LevelLocation:
    ...
    def get_logic_items(self, options: SonicAdventureDXOptions) -> List[str]:
        if options.logic_level.value == LogicLevelDifficulty.ExpertPlusDX:
            return self.expertPlusDXLogicItems
        elif options.logic_level.value == LogicLevelDifficulty.ExpertDX:
            return self.expertDXLogicItems
        elif options.logic_level.value == LogicLevelDifficulty.ExpertDC:
            return self.expertDCLogicItems
        elif options.logic_level.value == LogicLevelDifficulty.Hard:
            return self.hardLogicItems
        elif options.logic_level.value == LogicLevelDifficulty.Normal:
            return self.normalLogicItems
        else:
            return self.easyLogicItems
...
class EmblemLocation:
    locationId: int
    area: Area
    easyLogicCharacters: List[Union[CharacterUpgrade, Character]]
    ...
    def get_logic_characters_upgrades(self, options: SonicAdventureDXOptions) -> List[CharacterUpgrade | Character]:
        if options.logic_level.value == LogicLevelDifficulty.ExpertPlusDX:
            ...
            return self.easyLogicCharacters

    def get_logic_characters(self, options: SonicAdventureDXOptions) -> List[Character]:
        return self._get_characters(self.get_logic_characters_upgrades(options))
...
class SubLevelLocation:
    ...
    easyLogicCharacters: List[Character]
...
area_connections: Dict[Tuple[Character, Area, Area, bool], Tuple[
    List[str | List[str]], List[str | List[str]], List[str | List[str]], List[str | List[str]], List[str | List[str]],
    List[str | List[str]]]] = {
    (Character.Sonic, Area.CityHall, Area.SSMain, False): ([PolicePass], [PolicePass], [PolicePass], [], [PolicePass],
                                                           [PolicePass]),
    (Character.Sonic, Area.CityHall, Area.SpeedHighway, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [], []),
    ...
    (Character.Sonic, Area.CityHall, Area.Sewers, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [], [],
                                                           []),
    ...
    (Character.Sonic, Area.Sewers, Area.TPTunnel, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                           [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Sonic, Area.Station, Area.SSMain, False): ([StationKey], [StationKey], [StationKey], [], [], []),
    (Character.Sonic, Area.Station, Area.MRMain, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Sonic, Area.Station, Area.Casino, False): ([ShutterKey], [ShutterKey], [ShutterKey], [], [], []),
    (Character.Sonic, Area.Casino, Area.Station, False): ([ShutterKey], [ShutterKey], [ShutterKey], [], [], []),
    (Character.Sonic, Area.Casino, Area.Casinopolis, False): ([EMBLEM_BLOCKED, LightShoes],
                                                              [EMBLEM_BLOCKED, LightShoes], [EMBLEM_BLOCKED], [], [],
                                                              []),
    (Character.Sonic, Area.Casino, Area.Hotel, False): ([CasinoKey], [CasinoKey], [CasinoKey], [], [], []),
    (Character.Sonic, Area.Casino, Area.EggWalker, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                            [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Sonic, Area.SSMain, Area.Hotel, False): ([HotelKey], [HotelKey], [HotelKey], [], [], []),
    (Character.Sonic, Area.SSMain, Area.Station, False): ([StationKey], [StationKey], [StationKey], [], [], []),
    (Character.Sonic, Area.SSMain, Area.CityHall, False): ([PolicePass], [PolicePass], [PolicePass], [], [], []),
    (Character.Sonic, Area.SSMain, Area.ECBridge, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Sonic, Area.SSMain, Area.SpeedHighway, False): ([EmployeeCard], [EmployeeCard], [EmployeeCard], [], [],
                                                               []),
    (Character.Sonic, Area.SSMain, Area.TPTunnel, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    (Character.Sonic, Area.TPTunnel, Area.SSMain, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    (Character.Sonic, Area.TPTunnel, Area.Sewers, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                           [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Sonic, Area.TPTunnel, Area.TPLobby, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                            [], []),
    ...
    (Character.Sonic, Area.TPLobby, Area.TwinkleCircuit, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Sonic, Area.Hotel, Area.SSMain, False): ([HotelKey], [HotelKey], [HotelKey], [], [], []),
    ...
    (Character.Sonic, Area.Hotel, Area.Chaos2, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                        [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Sonic, Area.Hotel, Area.HotelPool, False): ([PoolKey], [PoolKey], [PoolKey], [], [], []),
    (Character.Sonic, Area.HotelPool, Area.Hotel, False): ([PoolKey], [PoolKey], [PoolKey], [], [PoolKey], [PoolKey]),
    (Character.Sonic, Area.HotelPool, Area.EmeraldCoast, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  [], [], []),
    (Character.Sonic, Area.MRMain, Area.Station, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Sonic, Area.MRMain, Area.ECBridge, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Sonic, Area.MRMain, Area.MRChaoGarden, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                               [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Sonic, Area.MRMain, Area.AngelIsland, False): ([Dynamite], [Dynamite], [Dynamite], [], [], []),
    (Character.Sonic, Area.AngelIsland, Area.MRMain, False): ([Dynamite], [Dynamite], [Dynamite], [], [], []),
    (Character.Sonic, Area.AngelIsland, Area.IceCave, False): ([IceStone], [IceStone], [IceStone], [], [], []),
    ...
    (Character.Sonic, Area.IceCave, Area.AngelIsland, False): ([IceStone], [IceStone], [IceStone], [], [], []),
    ...
    (Character.Sonic, Area.Jungle, Area.MRMain, False): ([JungleCart], [JungleCart], [JungleCart], [JungleCart],
                                                         [JungleCart], [JungleCart]),
    (Character.Sonic, Area.Jungle, Area.LostWorld, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                            [], []),
    (Character.Sonic, Area.Jungle, Area.LostWorld, True): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [], []),
    ...
    (Character.Sonic, Area.FinalEggTower, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Sonic, Area.ECBridge, Area.SSMain, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Sonic, Area.ECBridge, Area.MRMain, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Sonic, Area.ECBridge, Area.Chaos6ZeroBeta, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                   [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                   [EMBLEM_BLOCKED]),
    (Character.Sonic, Area.ECBridge, Area.ECInside, False): ([Monorail], [Monorail], [Monorail], [Monorail], [Monorail],
                                                             [Monorail]),
    (Character.Sonic, Area.ECDeck, Area.ECPool, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                         [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Sonic, Area.ECDeck, Area.CaptainRoom, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                              [], []),
    ...
    (Character.Sonic, Area.ECInside, Area.ECBridge, False): ([Monorail], [Monorail], [Monorail], [Monorail], [Monorail],
                                                             [Monorail]),
    ...
    (Character.Tails, Area.CityHall, Area.Chaos0, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                           [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Tails, Area.CityHall, Area.Sewers, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [], [],
                                                           []),
    ...
    (Character.Tails, Area.Station, Area.SSMain, False): ([StationKey], [StationKey], [StationKey], [], [StationKey],
                                                          [StationKey]),
    (Character.Tails, Area.Station, Area.MRMain, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Tails, Area.Station, Area.Casino, False): ([ShutterKey], [ShutterKey], [ShutterKey], [], [], []),
    (Character.Tails, Area.Casino, Area.Station, False): ([ShutterKey], [ShutterKey], [ShutterKey], [], [], []),
    (Character.Tails, Area.Casino, Area.Casinopolis, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                              [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.Casino, Area.Hotel, False): ([CasinoKey], [CasinoKey], [CasinoKey], [], [], []),
    (Character.Tails, Area.Casino, Area.EggWalker, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                            [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.SSMain, Area.Hotel, False): ([HotelKey], [HotelKey], [HotelKey], [], [], []),
    (Character.Tails, Area.SSMain, Area.Station, False): ([StationKey], [StationKey], [StationKey], [], [], []),
    (Character.Tails, Area.SSMain, Area.CityHall, False): ([PolicePass], [PolicePass], [PolicePass], [], [], []),
    (Character.Tails, Area.SSMain, Area.ECBridge, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Tails, Area.SSMain, Area.SpeedHighway, False): ([EmployeeCard], [EmployeeCard], [EmployeeCard], [], [],
                                                               []),
    (Character.Tails, Area.SSMain, Area.TPTunnel, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    (Character.Tails, Area.TPTunnel, Area.SSMain, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    (Character.Tails, Area.TPTunnel, Area.Sewers, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                           [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.TPTunnel, Area.TPLobby, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                            [], []),
    (Character.Tails, Area.TPLobby, Area.TPTunnel, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                            [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.TPLobby, Area.TwinklePark, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [], []),
    (Character.Tails, Area.TPLobby, Area.TwinkleCircuit, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.Hotel, Area.SSMain, False): ([HotelKey], [HotelKey], [HotelKey], [], [], []),
    (Character.Tails, Area.Hotel, Area.Casino, False): ([CasinoKey], [CasinoKey], [CasinoKey], [], [], []),
    ...
    (Character.Tails, Area.MRMain, Area.Station, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Tails, Area.MRMain, Area.ECBridge, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Tails, Area.MRMain, Area.MRChaoGarden, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                               [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.MRMain, Area.AngelIsland, False): ([Dynamite], [Dynamite], [Dynamite], [], [], []),
    (Character.Tails, Area.AngelIsland, Area.MRMain, False): ([Dynamite], [Dynamite], [Dynamite], [], [], []),
    (Character.Tails, Area.AngelIsland, Area.IceCave, False): ([IceStone], [IceStone], [IceStone], [], [], []),
    (Character.Tails, Area.AngelIsland, Area.RedMountain, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                                   [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO]),
    ...
    (Character.Tails, Area.Jungle, Area.MRMain, False): ([JungleCart], [JungleCart], [JungleCart], [JungleCart],
                                                         [JungleCart], [JungleCart]),
    (Character.Tails, Area.Jungle, Area.LostWorld, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [], []),
    ...
    (Character.Tails, Area.FinalEggTower, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.ECBridge, Area.SSMain, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Tails, Area.ECBridge, Area.MRMain, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Tails, Area.ECBridge, Area.Chaos6ZeroBeta, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                                   [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Tails, Area.ECBridge, Area.ECInside, False): ([Monorail], [Monorail], [Monorail], [Monorail], [Monorail],
                                                             [Monorail]),
    ...
    (Character.Tails, Area.CaptainRoom, Area.ECDeck, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                              [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.CaptainRoom, Area.PrivateRoom, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                   [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.PrivateRoom, Area.CaptainRoom, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                   [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    ...
    (Character.Tails, Area.ECPool, Area.ECDeck, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                         [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.ECPool, Area.SkyDeck, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [], []),
    (Character.Tails, Area.ECInside, Area.ECBridge, False): ([Monorail], [Monorail], [Monorail], [Monorail], [Monorail],
                                                             [Monorail]),
    ...
    (Character.Tails, Area.ECInside, Area.HotShelter, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [],
                                                               [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Tails, Area.ECInside, Area.HedgehogHammer, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                   [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.ECInside, Area.FinalEggTower, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    ...
    (Character.Tails, Area.ECInside, Area.WaterTank, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                              [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Tails, Area.HedgehogHammer, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                   [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    ...
    (Character.Knuckles, Area.CityHall, Area.Chaos0, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                              [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Knuckles, Area.CityHall, Area.Sewers, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                              [], []),
    ...
    (Character.Knuckles, Area.Station, Area.MRMain, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Knuckles, Area.Station, Area.Casino, False): ([ShutterKey], [ShutterKey], [ShutterKey], [], [], []),
    (Character.Knuckles, Area.Casino, Area.Station, False): ([ShutterKey], [ShutterKey], [ShutterKey], [], [], []),
    (Character.Knuckles, Area.Casino, Area.Casinopolis, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                 [], [], []),
    (Character.Knuckles, Area.Casino, Area.Hotel, False): ([CasinoKey], [CasinoKey], [CasinoKey], [CasinoKey],
    ...
    (Character.Knuckles, Area.SSMain, Area.Station, False): ([StationKey], [StationKey], [StationKey], [], [], []),
    (Character.Knuckles, Area.SSMain, Area.CityHall, False): ([PolicePass], [PolicePass], [PolicePass], [], [], []),
    (Character.Knuckles, Area.SSMain, Area.ECBridge, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Knuckles, Area.SSMain, Area.SpeedHighway, False): ([ONLY_RANDO, EmployeeCard],
                                                                  [ONLY_RANDO, EmployeeCard],
                                                                  [ONLY_RANDO, EmployeeCard], [], [], []),
    (Character.Knuckles, Area.SSMain, Area.TPTunnel, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    (Character.Knuckles, Area.TPTunnel, Area.SSMain, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    ...
    (Character.Knuckles, Area.TPLobby, Area.TwinkleCircuit, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                     [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                     [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Knuckles, Area.Hotel, Area.SSMain, False): ([HotelKey], [HotelKey], [HotelKey], [], [], []),
    (Character.Knuckles, Area.Hotel, Area.Casino, False): ([CasinoKey], [CasinoKey], [CasinoKey], [], [], []),
    ...
    (Character.Knuckles, Area.Hotel, Area.Chaos2, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                           [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Knuckles, Area.Hotel, Area.HotelPool, False): ([PoolKey], [PoolKey], [PoolKey], [], [], []),
    ...
    (Character.Knuckles, Area.HotelPool, Area.EmeraldCoast, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                                     [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Knuckles, Area.MRMain, Area.Station, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Knuckles, Area.MRMain, Area.ECBridge, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Knuckles, Area.MRMain, Area.MRChaoGarden, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Knuckles, Area.MRMain, Area.AngelIsland, False): ([Dynamite], [Dynamite], [Dynamite], [], [], []),
    (Character.Knuckles, Area.AngelIsland, Area.MRMain, False): ([Dynamite], [Dynamite], [Dynamite], [], [], []),
    (Character.Knuckles, Area.AngelIsland, Area.IceCave, False): ([IceStone], [IceStone], [IceStone], [], [], []),
    ...
    (Character.Knuckles, Area.Jungle, Area.MRMain, False): ([JungleCart], [JungleCart], [JungleCart], [JungleCart],
                                                            [JungleCart], [JungleCart]),
    (Character.Knuckles, Area.Jungle, Area.LostWorld, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [], []),
    ...
    (Character.Knuckles, Area.FinalEggTower, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                     [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                     [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Knuckles, Area.ECBridge, Area.SSMain, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Knuckles, Area.ECBridge, Area.MRMain, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Knuckles, Area.ECInside, Area.FinalEggTower, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                     [EMBLEM_BLOCKED], [], [EMBLEM_BLOCKED],
                                                                     [EMBLEM_BLOCKED]),
    (Character.Knuckles, Area.ECInside, Area.WarpHall, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Knuckles, Area.ECInside, Area.Arsenal, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                               [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Knuckles, Area.ECInside, Area.WaterTank, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                 [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    ...
    (Character.Knuckles, Area.Arsenal, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                               [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Knuckles, Area.WaterTank, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                 [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Knuckles, Area.WarpHall, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                [], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    ...
    (Character.Amy, Area.Station, Area.SSMain, False): ([StationKey], [StationKey], [StationKey], [StationKey],
                                                        [StationKey], [StationKey]),
    (Character.Amy, Area.Station, Area.MRMain, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Amy, Area.Station, Area.Casino, False): ([ShutterKey], [ShutterKey], [ShutterKey], [], [], []),
    ...
    (Character.Amy, Area.Casino, Area.EggWalker, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                          [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Amy, Area.SSMain, Area.Hotel, False): ([HotelKey], [HotelKey], [HotelKey], [], [], []),
    (Character.Amy, Area.SSMain, Area.Station, False): ([StationKey], [StationKey], [StationKey], [], [], []),
    (Character.Amy, Area.SSMain, Area.CityHall, False): ([PolicePass], [PolicePass], [PolicePass], [PolicePass], [],
                                                         []),
    (Character.Amy, Area.SSMain, Area.ECBridge, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Amy, Area.SSMain, Area.SpeedHighway, False): ([ONLY_RANDO, EmployeeCard], [ONLY_RANDO, EmployeeCard],
                                                             [ONLY_RANDO, EmployeeCard], [], [], []),
    (Character.Amy, Area.SSMain, Area.TPTunnel, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    (Character.Amy, Area.TPTunnel, Area.SSMain, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    ...
    (Character.Amy, Area.TPLobby, Area.TwinkleCircuit, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Amy, Area.Hotel, Area.SSMain, False): ([HotelKey], [HotelKey], [HotelKey], [], [], []),
    (Character.Amy, Area.Hotel, Area.Casino, False): ([CasinoKey], [CasinoKey], [CasinoKey], [], [], []),
    ...
    (Character.Amy, Area.HotelPool, Area.EmeraldCoast, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                                [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Amy, Area.MRMain, Area.Station, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Amy, Area.MRMain, Area.ECBridge, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Amy, Area.AngelIsland, Area.MRMain, False): ([Dynamite], [Dynamite], [Dynamite], [Dynamite], [Dynamite],
                                                            [Dynamite]),
    (Character.Amy, Area.AngelIsland, Area.IceCave, False): ([IceStone], [IceStone], [IceStone], [IceStone], [IceStone],
                                                             [IceStone]),
    ...
    (Character.Amy, Area.AngelIsland, Area.PastAltar, False): ([TimeMachine], [TimeMachine], [TimeMachine],
                                                               [TimeMachine], [TimeMachine], [TimeMachine]),
    (Character.Amy, Area.IceCave, Area.AngelIsland, False): ([IceStone], [IceStone], [IceStone], [IceStone], [IceStone],
                                                             [IceStone]),
    ...
    (Character.Amy, Area.Jungle, Area.MRMain, False): ([JungleCart], [JungleCart], [JungleCart], [JungleCart],
                                                       [JungleCart], [JungleCart]),
    (Character.Amy, Area.Jungle, Area.LostWorld, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [], []),
    ...
    (Character.Amy, Area.FinalEggTower, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Amy, Area.ECBridge, Area.SSMain, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Amy, Area.ECBridge, Area.MRMain, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Big, Area.Station, Area.SSMain, False): ([StationKey], [StationKey], [StationKey], [StationKey],
                                                        [StationKey], [StationKey]),
    (Character.Big, Area.Station, Area.MRMain, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    ...
    (Character.Big, Area.Casino, Area.EggWalker, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                          [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Big, Area.SSMain, Area.Hotel, False): ([HotelKey], [HotelKey], [HotelKey], [HotelKey], [[HotelKey],
                                                                                                       [LifeBelt]], []),
    (Character.Big, Area.SSMain, Area.Station, False): ([StationKey], [StationKey], [StationKey], [], [], []),
    (Character.Big, Area.SSMain, Area.CityHall, False): ([PolicePass], [PolicePass], [PolicePass], [PolicePass],
                                                         [PolicePass], [PolicePass]),
    (Character.Big, Area.SSMain, Area.ECBridge, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    ...
    (Character.Big, Area.SSMain, Area.TPTunnel, False): ([TPTicket], [TPTicket], [TPTicket], [TPTicket], [TPTicket],
                                                         [TPTicket]),
    (Character.Big, Area.TPTunnel, Area.SSMain, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    ...
    (Character.Big, Area.HotelPool, Area.EmeraldCoast, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Big, Area.MRMain, Area.Station, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Big, Area.MRMain, Area.ECBridge, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Big, Area.AngelIsland, Area.MRMain, False): ([Dynamite], [Dynamite], [Dynamite], [Dynamite], [Dynamite],
                                                            [Dynamite]),
    (Character.Big, Area.AngelIsland, Area.IceCave, False): ([IceStone], [IceStone], [IceStone], [IceStone], [IceStone],
                                                             [IceStone]),
    ...
    (Character.Big, Area.AngelIsland, Area.PastAltar, False): ([TimeMachine], [TimeMachine], [TimeMachine],
                                                               [TimeMachine], [TimeMachine], [TimeMachine]),
    (Character.Big, Area.IceCave, Area.AngelIsland, False): ([IceStone], [IceStone], [IceStone], [IceStone], [IceStone],
                                                             [IceStone]),
    ...
    (Character.Big, Area.Jungle, Area.MRMain, False): ([JungleCart], [JungleCart], [JungleCart], [JungleCart],
                                                       [JungleCart], [JungleCart]),
    (Character.Big, Area.Jungle, Area.LostWorld, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [], []),
    ...
    (Character.Big, Area.FinalEggTower, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Big, Area.ECBridge, Area.SSMain, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Big, Area.ECBridge, Area.MRMain, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Gamma, Area.Station, Area.SSMain, False): ([StationKey], [StationKey], [StationKey], [StationKey],
                                                          [StationKey], [StationKey]),
    (Character.Gamma, Area.Station, Area.MRMain, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Gamma, Area.Station, Area.Casino, False): ([ShutterKey], [ShutterKey], [ShutterKey], [], [], []),
    ...
    (Character.Gamma, Area.Casino, Area.Casinopolis, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                              [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Gamma, Area.Casino, Area.Hotel, False): ([CasinoKey], [CasinoKey], [CasinoKey], [CasinoKey], [CasinoKey],
                                                        [CasinoKey]),
    (Character.Gamma, Area.Casino, Area.EggWalker, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                            [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Gamma, Area.SSMain, Area.Hotel, False): ([HotelKey], [HotelKey], [HotelKey], [HotelKey], [], []),
    (Character.Gamma, Area.SSMain, Area.Station, False): ([StationKey], [StationKey], [StationKey], [StationKey], [],
                                                          []),
    (Character.Gamma, Area.SSMain, Area.CityHall, False): ([PolicePass], [PolicePass], [PolicePass], [], [PolicePass],
                                                           [PolicePass]),
    (Character.Gamma, Area.SSMain, Area.ECBridge, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Gamma, Area.SSMain, Area.SpeedHighway, False): ([ONLY_RANDO, EmployeeCard], [ONLY_RANDO, EmployeeCard],
                                                               ...
                                                               [], []),
    (Character.Gamma, Area.SSMain, Area.TPTunnel, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    (Character.Gamma, Area.TPTunnel, Area.SSMain, False): ([TPTicket], [TPTicket], [TPTicket], [], [], []),
    ...
    (Character.Gamma, Area.Hotel, Area.Casino, False): ([CasinoKey], [CasinoKey], [CasinoKey], [], [[CasinoKey],
                                                                                                    [JetBooster]], []),
    ...
    (Character.Gamma, Area.Hotel, Area.Chaos2, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO],
                                                        [ONLY_RANDO], [ONLY_RANDO]),
    (Character.Gamma, Area.Hotel, Area.HotelPool, False): ([PoolKey], [PoolKey], [PoolKey], [], [], []),
    ...
    (Character.Gamma, Area.HotelPool, Area.EmeraldCoast, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Gamma, Area.MRMain, Area.Station, False): ([Train], [Train], [Train], [Train], [Train], [Train]),
    (Character.Gamma, Area.MRMain, Area.ECBridge, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Gamma, Area.MRMain, Area.MRChaoGarden, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                               [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Gamma, Area.MRMain, Area.AngelIsland, False): ([Dynamite], [Dynamite], [Dynamite],
                                                              [[Dynamite], [JetBooster]], [[Dynamite],
                                                                                           [JetBooster]], [[Dynamite],
                                                                                                           [JetBooster]]),
    ...
    (Character.Gamma, Area.Jungle, Area.MRMain, False): ([JungleCart], [JungleCart], [JungleCart], [JungleCart],
                                                         [JungleCart], [JungleCart]),
    (Character.Gamma, Area.Jungle, Area.LostWorld, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [], []),
    ...
    (Character.Gamma, Area.FinalEggTower, Area.ECInside, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED]),
    (Character.Gamma, Area.ECBridge, Area.SSMain, False): ([Boat], [Boat], [Boat], [Boat], [Boat], [Boat]),
    (Character.Gamma, Area.ECBridge, Area.MRMain, False): ([Raft], [Raft], [Raft], [Raft], [Raft], [Raft]),
    ...
    (Character.Gamma, Area.ECBridge, Area.Chaos6ZeroBeta, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                   [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                   [EMBLEM_BLOCKED]),
    (Character.Gamma, Area.ECBridge, Area.ECInside, False): ([Monorail], [Monorail], [Monorail], [Monorail], [Monorail],
                                                             [Monorail]),
    ...
    (Character.Gamma, Area.ECPool, Area.SkyDeck, False): ([ONLY_RANDO], [ONLY_RANDO], [ONLY_RANDO], [], [ONLY_RANDO],
                                                          [ONLY_RANDO]),
    (Character.Gamma, Area.ECInside, Area.ECBridge, False): ([Monorail], [Monorail], [Monorail], [Monorail], [Monorail],
                                                             [Monorail]),
    (Character.Gamma, Area.ECInside, Area.ECDeck, True): ([Egglift], [Egglift], [Egglift], [Egglift], [Egglift],
                                                          [Egglift]),
    (Character.Gamma, Area.ECInside, Area.HotShelter, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                               [[EMBLEM_BLOCKED], [JetBooster]],
                                                               [[EMBLEM_BLOCKED], [JetBooster]],
                                                               [[EMBLEM_BLOCKED], [JetBooster]]),
    (Character.Gamma, Area.ECInside, Area.HedgehogHammer, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                   [[EMBLEM_BLOCKED], [JetBooster]],
                                                                   [[EMBLEM_BLOCKED], [JetBooster]],
                                                                   [[EMBLEM_BLOCKED], [JetBooster]]),
    (Character.Gamma, Area.ECInside, Area.FinalEggTower, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                                  ...
                                                                  [[EMBLEM_BLOCKED], [JetBooster]],
                                                                  [[EMBLEM_BLOCKED], [JetBooster]]),
    (Character.Gamma, Area.ECInside, Area.WarpHall, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                             [[EMBLEM_BLOCKED], [JetBooster]],
                                                             [[EMBLEM_BLOCKED], [JetBooster]],
                                                             [[EMBLEM_BLOCKED], [JetBooster]]),
    (Character.Gamma, Area.ECInside, Area.Arsenal, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [],
                                                            [], []),
    (Character.Gamma, Area.ECInside, Area.WaterTank, False): ([EMBLEM_BLOCKED], [EMBLEM_BLOCKED], [EMBLEM_BLOCKED],
                                                              [[EMBLEM_BLOCKED], [JetBooster]],
                                                              [[EMBLEM_BLOCKED], [JetBooster]],
                                                              [[EMBLEM_BLOCKED], [JetBooster]]),
...
level_location_table: List[LevelLocation] = [
    ...
    LevelLocation(6000, Area.TwinklePark, Character.Big, LevelMission.A, [Lure1, Lure2, Lure3, Lure4],
                  ...
                  [Lure1, Lure2, Lure3, Lure4], [Lure1, Lure2, Lure3, Lure4]),
    ...
    LevelLocation(6303, Area.HotShelter, Character.Big, LevelMission.S, [Lure1, Lure2, Lure3, Lure4],
                  [Lure1, Lure2, Lure3, Lure4], [Lure1, Lure2, Lure3, Lure4], [], [], []),
    LevelLocation(5402, Area.HotShelter, Character.Gamma, LevelMission.C, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    LevelLocation(5401, Area.HotShelter, Character.Gamma, LevelMission.B, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    LevelLocation(5400, Area.HotShelter, Character.Gamma, LevelMission.A, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    LevelLocation(5403, Area.HotShelter, Character.Gamma, LevelMission.S, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
]
...
field_emblem_location_table: List[EmblemLocation] = [
    ...
    EmblemLocation(12, Area.CityHall, [P_TAILS, P_KNUCKLES_W_SC], [P_TAILS, P_KNUCKLES_W_SC],
                   [P_TAILS, P_KNUCKLES_W_SC], [P_AMY, P_TAILS, P_KNUCKLES, P_SONIC_W_LS], [P_AMY, P_TAILS, P_KNUCKLES],
                   [P_AMY, P_TAILS, P_KNUCKLES], "City Hall Emblem"),
    EmblemLocation(13, Area.Casino, [P_TAILS], [P_TAILS], [P_TAILS], [P_TAILS, P_SONIC, P_KNUCKLES, P_AMY],
                   [P_TAILS, P_SONIC], [P_TAILS, P_SONIC, P_KNUCKLES], "Casino Emblem"),
    EmblemLocation(20, Area.MRMain, [P_TAILS, P_KNUCKLES, P_GAMMA_W_JB], [P_SONIC, P_TAILS, P_KNUCKLES, P_GAMMA_W_JB],
                   [P_SONIC, P_TAILS, P_KNUCKLES, P_GAMMA_W_JB], [P_SONIC, P_TAILS, P_KNUCKLES, P_GAMMA_W_JB, P_AMY],
    ...
    EmblemLocation(21, Area.AngelIsland, [P_KNUCKLES], [P_TAILS, P_KNUCKLES, P_GAMMA_W_JB],
                   [P_TAILS, P_KNUCKLES, P_GAMMA_W_JB], [P_SONIC, P_TAILS, P_KNUCKLES, P_GAMMA_W_JB],
    ...
    EmblemLocation(23, Area.Jungle, [P_TAILS, P_KNUCKLES], [P_TAILS, P_KNUCKLES], [P_SONIC, P_TAILS, P_KNUCKLES],
    ...
    EmblemLocation(30, Area.ECPool, [P_TAILS, P_KNUCKLES], [P_TAILS, P_KNUCKLES], [P_SONIC, P_TAILS, P_KNUCKLES, P_AMY],
    ...
    EmblemLocation(31, Area.ECDeck, [P_TAILS], [P_TAILS, P_KNUCKLES], [P_TAILS, P_SONIC, P_KNUCKLES],
    ...
    EmblemLocation(33, Area.ECBridge, [P_SONIC], [P_SONIC, P_BIG, P_KNUCKLES, P_AMY],
                   [P_SONIC, P_BIG, P_KNUCKLES, P_AMY], [P_SONIC, P_BIG, P_KNUCKLES, P_AMY, P_TAILS],
...
mission_location_table: List[MissionLocation] = [
    MissionLocation(801, Area.SSMain, Area.SSMain, Character.Sonic, 1, [PolicePass], [PolicePass], [PolicePass],
                    [PolicePass], [PolicePass], [PolicePass]),
    ...
    MissionLocation(803, Area.HotelPool, Area.HotelPool, Character.Sonic, 3, [LightShoes], [LightShoes], [LightShoes],
                    [LightShoes], [LightShoes], [LightShoes]),
    ...
    MissionLocation(834, Area.ECOutside, Area.ECOutside, Character.Sonic, 34, [LightShoes], [LightShoes], [LightShoes],
                    [], [], []),
    ...
    MissionLocation(856, Area.MRMain, Area.RedMountain, Character.Knuckles, 56, [ShovelClaw], [ShovelClaw],
                    [ShovelClaw], [ShovelClaw], [ShovelClaw], []),
...
sub_level_location_table: List[SubLevelLocation] = [
    ...
    SubLevelLocation(45, Area.TwinkleCircuit, SubLevel.TwinkleCircuit, SubLevelMission.Gamma, [P_GAMMA], [P_GAMMA],
                     [P_GAMMA], [P_GAMMA], [P_GAMMA], [P_GAMMA]),
    SubLevelLocation(25, Area.SandHill, SubLevel.SandHill, SubLevelMission.B, [P_TAILS], [P_TAILS], [P_TAILS],
                     [P_TAILS, P_SONIC], [P_TAILS, P_SONIC], [P_TAILS, P_SONIC]),
    SubLevelLocation(26, Area.SandHill, SubLevel.SandHill, SubLevelMission.A, [P_TAILS], [P_TAILS], [P_TAILS],
                     [P_TAILS, P_SONIC], [P_TAILS, P_SONIC], [P_TAILS, P_SONIC]),
...
enemy_location_table: List[EnemyLocation] = [
    ...
    EnemyLocation(54020, Area.HotShelter, Character.Gamma, 20, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54021, Area.HotShelter, Character.Gamma, 21, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54022, Area.HotShelter, Character.Gamma, 22, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54023, Area.HotShelter, Character.Gamma, 23, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54024, Area.HotShelter, Character.Gamma, 24, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54025, Area.HotShelter, Character.Gamma, 25, Enemy.EggKeeper, [JetBooster], [JetBooster],
                  [JetBooster], [], [], []),
    EnemyLocation(54026, Area.HotShelter, Character.Gamma, 26, Enemy.Leon, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54027, Area.HotShelter, Character.Gamma, 27, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54028, Area.HotShelter, Character.Gamma, 28, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54029, Area.HotShelter, Character.Gamma, 29, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54030, Area.HotShelter, Character.Gamma, 30, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54031, Area.HotShelter, Character.Gamma, 31, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54032, Area.HotShelter, Character.Gamma, 32, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54033, Area.HotShelter, Character.Gamma, 33, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54034, Area.HotShelter, Character.Gamma, 34, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54035, Area.HotShelter, Character.Gamma, 35, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54036, Area.HotShelter, Character.Gamma, 36, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54037, Area.HotShelter, Character.Gamma, 37, Enemy.EggKeeper, [JetBooster], [JetBooster],
                  [JetBooster], [], [], []),
    EnemyLocation(54038, Area.HotShelter, Character.Gamma, 38, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54039, Area.HotShelter, Character.Gamma, 39, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54040, Area.HotShelter, Character.Gamma, 40, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54041, Area.HotShelter, Character.Gamma, 41, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54042, Area.HotShelter, Character.Gamma, 42, Enemy.EggKeeper, [JetBooster], [JetBooster],
                  [JetBooster], [], [], []),
    EnemyLocation(54043, Area.HotShelter, Character.Gamma, 43, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54044, Area.HotShelter, Character.Gamma, 44, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54045, Area.HotShelter, Character.Gamma, 45, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54046, Area.HotShelter, Character.Gamma, 46, Enemy.Leon, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54047, Area.HotShelter, Character.Gamma, 47, Enemy.Leon, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54048, Area.HotShelter, Character.Gamma, 48, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54049, Area.HotShelter, Character.Gamma, 49, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54050, Area.HotShelter, Character.Gamma, 50, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54051, Area.HotShelter, Character.Gamma, 51, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54052, Area.HotShelter, Character.Gamma, 52, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54053, Area.HotShelter, Character.Gamma, 53, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54054, Area.HotShelter, Character.Gamma, 54, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54055, Area.HotShelter, Character.Gamma, 55, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54056, Area.HotShelter, Character.Gamma, 56, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54057, Area.HotShelter, Character.Gamma, 57, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54058, Area.HotShelter, Character.Gamma, 58, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54059, Area.HotShelter, Character.Gamma, 59, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54060, Area.HotShelter, Character.Gamma, 60, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54061, Area.HotShelter, Character.Gamma, 61, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54062, Area.HotShelter, Character.Gamma, 62, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54063, Area.HotShelter, Character.Gamma, 63, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54064, Area.HotShelter, Character.Gamma, 64, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54065, Area.HotShelter, Character.Gamma, 65, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54066, Area.HotShelter, Character.Gamma, 66, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54067, Area.HotShelter, Character.Gamma, 67, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54068, Area.HotShelter, Character.Gamma, 68, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54069, Area.HotShelter, Character.Gamma, 69, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54070, Area.HotShelter, Character.Gamma, 70, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54071, Area.HotShelter, Character.Gamma, 71, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54072, Area.HotShelter, Character.Gamma, 72, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54073, Area.HotShelter, Character.Gamma, 73, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54074, Area.HotShelter, Character.Gamma, 74, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54075, Area.HotShelter, Character.Gamma, 75, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54076, Area.HotShelter, Character.Gamma, 76, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54077, Area.HotShelter, Character.Gamma, 77, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54078, Area.HotShelter, Character.Gamma, 78, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54079, Area.HotShelter, Character.Gamma, 79, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54080, Area.HotShelter, Character.Gamma, 80, Enemy.Leon, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54081, Area.HotShelter, Character.Gamma, 81, Enemy.Leon, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54082, Area.HotShelter, Character.Gamma, 82, Enemy.Leon, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54083, Area.HotShelter, Character.Gamma, 83, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54084, Area.HotShelter, Character.Gamma, 84, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54085, Area.HotShelter, Character.Gamma, 85, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54086, Area.HotShelter, Character.Gamma, 86, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54087, Area.HotShelter, Character.Gamma, 87, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54088, Area.HotShelter, Character.Gamma, 88, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54089, Area.HotShelter, Character.Gamma, 89, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54090, Area.HotShelter, Character.Gamma, 90, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54091, Area.HotShelter, Character.Gamma, 91, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54092, Area.HotShelter, Character.Gamma, 92, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    ...
    EnemyLocation(54094, Area.HotShelter, Character.Gamma, 94, Enemy.EggKeeper, [JetBooster], [JetBooster],
                  [JetBooster], [], [], []),
    EnemyLocation(54095, Area.HotShelter, Character.Gamma, 95, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54096, Area.HotShelter, Character.Gamma, 96, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54097, Area.HotShelter, Character.Gamma, 97, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54098, Area.HotShelter, Character.Gamma, 98, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54099, Area.HotShelter, Character.Gamma, 99, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster], [],
                  [], []),
    EnemyLocation(54100, Area.HotShelter, Character.Gamma, 100, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    ...
    EnemyLocation(54104, Area.HotShelter, Character.Gamma, 104, Enemy.EggKeeper, [JetBooster], [JetBooster],
                  [JetBooster], [], [], []),
    EnemyLocation(54105, Area.HotShelter, Character.Gamma, 105, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54106, Area.HotShelter, Character.Gamma, 106, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54107, Area.HotShelter, Character.Gamma, 107, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54108, Area.HotShelter, Character.Gamma, 108, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54109, Area.HotShelter, Character.Gamma, 109, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54110, Area.HotShelter, Character.Gamma, 110, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54111, Area.HotShelter, Character.Gamma, 111, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54112, Area.HotShelter, Character.Gamma, 112, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54113, Area.HotShelter, Character.Gamma, 113, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54114, Area.HotShelter, Character.Gamma, 114, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54115, Area.HotShelter, Character.Gamma, 115, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54116, Area.HotShelter, Character.Gamma, 116, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
    EnemyLocation(54117, Area.HotShelter, Character.Gamma, 117, Enemy.Kiki, [JetBooster], [JetBooster], [JetBooster],
                  [], [], []),
...
capsule_location_table: List[CapsuleLocation] = [
    ...
    CapsuleLocation(16511, Area.RedMountain, Character.Sonic, 11, Capsule.ExtraLife, [LightShoes], [LightShoes], [], [],
                    [], []),
    CapsuleLocation(16512, Area.RedMountain, Character.Sonic, 12, Capsule.ExtraLife, [LightShoes], [LightShoes], [], [],
                    [], []),
    ...
    CapsuleLocation(54531, Area.HotShelter, Character.Gamma, 31, Capsule.Shield, [JetBooster], [JetBooster],
                    [JetBooster], [], [], []),
    CapsuleLocation(54532, Area.HotShelter, Character.Gamma, 32, Capsule.Bomb, [JetBooster], [JetBooster], [JetBooster],
                    [], [], []),
